...
![ETGraph Overview](/diagrams/overview.png)

## Key Features

The ETGraph dataset offers several key features that make it a valuable resource for analyzing the Ethereum network and its connection with Twitter:
